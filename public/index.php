...
//     ],
// ];
// // print_r($arrayTest["pera"])
// if(array_key_exists($fruta, $arrayTest )) {  // Estamos preguntando si pera(4fruta) existe en el array.
//     $color = $arrayTest[$fruta]["color"];
//     $sabor = $arrayTest[$fruta]["sabor"];
//     echo "Color: $color";
//     echo "Sabor: $sabor";
// }